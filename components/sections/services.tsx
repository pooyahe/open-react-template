...
export default function Services() {
  return (
    <section id="leistungen" className="section-space bg-[var(--blue-haze)]">
      <div className="site-container">
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          {homepageContent.services.map((service) => (
            <article key={service.title} className="min-w-0 flex flex-col border border-blue-200/80 bg-white/95 p-7 shadow-[0_16px_45px_rgba(24,66,112,0.07)] sm:p-8">
              ...
              <h3 className="mt-7 text-2xl font-bold tracking-[-0.02em] text-[var(--ink)] [overflow-wrap:anywhere]">{service.title}</h3>
