  ...
  return (
    <main id="main-content" tabIndex={-1} className="site-container section-space">
      ...
      <div className="mt-8 max-w-2xl space-y-5 leading-8 text-[var(--muted)]">
        ...
        <p>Wenn Sie das Kontaktformular nutzen, verarbeiten wir Ihren Namen, Ihre E-Mail-Adresse, Ihre Nachricht sowie die freiwillig angegebenen Informationen zu Unternehmen und Telefonnummer, um Ihre Anfrage zu beantworten. Die Angaben werden nicht in einer Anwendungsdatenbank gespeichert.</p>
        <p>Für die technische Übermittlung der Anfrage per E-Mail wird Brevo als Versanddienstleister eingesetzt. Die Formulardaten werden serverseitig an Brevo übermittelt und anschließend an unser IONOS-Postfach zugestellt. Technisch erforderliche Metadaten können in den Protokollen der beteiligten Hosting- und E-Mail-Dienstleister verarbeitet werden.</p>
