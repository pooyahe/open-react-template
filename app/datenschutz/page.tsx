  ...
  return (
    <main id="main-content" tabIndex={-1} className="site-container section-space">
      ...
      <div className="mt-8 max-w-2xl space-y-5 leading-8 text-[var(--muted)]">
        ...
        <p>Auf der Website werden keine Analyse- oder Marketingdienste, keine externen Schriftarten, kein Kontaktformular und keine nicht notwendigen Cookies eingesetzt. Die Kontaktbuttons öffnen Ihr eigenes E-Mail-Programm oder die Telefonfunktion Ihres Geräts. Die Verarbeitung der anschließenden Kommunikation richtet sich nach dem von Ihnen verwendeten E-Mail- oder Telefonanbieter.</p>
