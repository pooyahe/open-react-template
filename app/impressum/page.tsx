  ...
  return (
    <main id="main-content" tabIndex={-1} className="site-container section-space">
      ...
      <div className="mt-8 max-w-2xl space-y-5 leading-8 text-[var(--muted)]">
        <p>AktenKompass ist ein Pre-Launch-Digitalisierungsprojekt, betrieben von Dr. Pouya Hedayati. Es besteht derzeit kein eingetragener Gewerbebetrieb oder Unternehmen in der Rechtsform einer GmbH oder UG.</p>
        <p>Verantwortlich für den Inhalt:<br />Dr. Pouya Hedayati<br />Gärtnerstr. 29<br />80992 München<br />Deutschland</p>
