...
| Require server-side form validation, size limits, rate limiting, and honeypot | Basic abuse and input protection before enabling form delivery | Confirmed requirement; implementation pending |
