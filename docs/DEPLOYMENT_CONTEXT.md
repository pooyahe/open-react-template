...
| Business status | No legal status confirmed; project is pre-launch | Context interview | UNRESOLVED | Legal | Public launch requires an appropriate legal-status decision and accurate wording |
| Published address | Gärtnerstr. 29, 80992 Munich, Germany; home address | Context interview | LEGAL_REVIEW_REQUIRED | Personal | Must be approved for publication and used accurately in Impressum/legal material |
